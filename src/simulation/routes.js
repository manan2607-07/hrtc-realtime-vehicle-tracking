...
export const ROUTES = [
  {
    ...
    segmentSpeeds: {
      normal: [25, 22, 20, 18, 20, 22, 20, 18, 15, 20, 22, 25, 22, 18, 15, 18, 20, 22, 25, 20, 18, 15, 18, 20, 22, 20, 18, 15, 18, 20, 22, 25, 22, 20, 18],
      touristSeason: [15, 12, 10, 10, 12, 15, 12, 10, 8, 12, 15, 18, 15, 10, 8, 10, 12, 15, 18, 12, 10, 8, 10, 12, 15, 12, 10, 8, 10, 12, 15, 18, 15, 12, 10],
    },
    color: '#2980B9',
  },
  {
    ...
    segmentSpeeds: {
      normal: [35, 30, 28, 30, 35, 30, 25, 30, 35, 40, 35, 30, 25, 30, 35, 40, 35, 30, 25, 30, 35, 30, 25, 25, 30, 35, 30, 25, 30, 35, 30, 25, 30, 35, 30, 25, 30, 35, 30],
      touristSeason: [20, 18, 15, 18, 22, 18, 15, 18, 22, 25, 22, 18, 15, 18, 22, 25, 22, 18, 15, 18, 22, 18, 15, 15, 18, 22, 18, 15, 18, 22, 18, 15, 18, 22, 18, 15, 18, 22, 18],
    },
    color: '#E74C3C',
  },
  {
    ...
    segmentSpeeds: {
      normal: [18, 15, 15, 18, 15, 12, 15, 12, 15, 15, 12, 10, 12, 15, 12, 10, 12, 10, 10],
      touristSeason: [10, 8, 8, 10, 8, 6, 8, 6, 8, 8, 6, 5, 6, 8, 6, 5, 6, 5, 5],
    },
    color: '#27AE60',
  },
  {
    ...
    segmentSpeeds: {
      normal: [30, 35, 35, 40, 45, 50, 45, 40, 35, 30, 45, 50, 55, 45, 40],
      touristSeason: [20, 22, 22, 25, 30, 35, 30, 25, 22, 20, 30, 35, 40, 30, 25],
    },
    color: '#8E44AD',
  },
  {
    ...
    segmentSpeeds: {
      normal: [35, 40, 45, 40, 45, 50, 55, 50, 45, 50, 55, 60, 55, 50, 45],
      touristSeason: [25, 30, 30, 25, 30, 35, 40, 35, 30, 35, 40, 45, 40, 35, 30],
    },
    color: '#D35400',
  },
  {
    ...
    segmentSpeeds: {
      normal: [40, 45, 40, 35, 45, 50, 45, 40, 60, 65, 60, 55, 65, 70, 65],
      touristSeason: [25, 30, 25, 20, 30, 35, 30, 25, 45, 50, 45, 40, 50, 55, 50],
    },
    color: '#16A085',
  },
  {
    ...
    segmentSpeeds: {
      normal: [30, 35, 30, 35, 40, 35, 40, 45, 40, 35, 40, 35, 30],
      touristSeason: [20, 22, 20, 22, 25, 22, 25, 30, 25, 22, 25, 22, 20],
    },
    color: '#2C3E50',
  },
  {
    ...
    segmentSpeeds: {
      normal: [30, 32, 35, 30, 35, 30],
      touristSeason: [20, 22, 22, 20, 22, 20],
    },
    color: '#F39C12',
  },
];
