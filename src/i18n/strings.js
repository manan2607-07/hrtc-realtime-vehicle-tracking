...
export const STRINGS = {
  ...
  hinglish: {
    ...
    // Navigation
    navHome: 'Home',
    navTrack: 'Bus Track Karein',
    navRoutes: 'Routes List',
    navSMS: 'SMS Bus Tracker',
    navAdmin: 'Admin Panel',
    navAlerts: 'Alerts',
    navReports: 'Reports',
    navFleetMap: 'Fleet Map',
    navRouteManager: 'Routes Control',

    // Home
    searchPlaceholder: 'Route, stop ya destination search karein...',
    nearbyStops: 'Paas ke Bus Stops',
    popularRoutes: 'Popular Routes',
    allRoutes: 'Sabhi Routes',
    activeBuses: 'Chalti Hui Buses',
    busesNearMe: 'Mere Paas ki Buses',
    viewRoute: 'Route Dekhein',
    trackBus: 'Live Track Karein',

    // Live tracking
    liveTracking: 'Live Bus Tracking',
    nextStop: 'Agla Stop',
    finalDestination: 'Aakhri Destination',
    etaLabel: 'Kab Pahuchegi (ETA)',
    arriving: 'Bas Pahunchne Wali Hai',
    signalLost: 'GPS Signal Chhut Gaya',
    lastUpdated: 'Aakhri update',
    secondsAgo: 'sec pehle',
    minutesAgo: 'min pehle',
    estimateWarning: 'Estimate dikha rahe hain — GPS unavailable',
    notifyMe: '5 min pehle alert karein',
    notificationSet: 'Alert set ho gaya! Hum notify karenge.',
    upcomingStops: 'Aage ke Stops',
    confidence: 'Accuracy',
    live: 'Live GPS',
    estimated: 'Estimated',
    lowConfidence: 'Kam Accurate',

    // Stop detail
    upcomingBuses: 'Aane Wali Buses',
    noBuses: 'Is waqt koi bus scheduled nahi hai',
    stopCode: 'Stop Code',
    ...
    stops: 'Stops',
    schedule: 'Time Table',
    distance: 'Doori (Distance)',
    typicalDuration: 'Kitna Time Lagega',
    activeBusesOnRoute: 'Is Route pe Chalti Buses',

    // Sustainability
    fuelType: 'Fuel Type',
    emissionStandard: 'Engine Standard',
    electric: 'Electric (EV)',
    diesel: 'Diesel',
    cng: 'CNG',
    hybrid: 'Hybrid',
    zeroEmission: 'Zero Pollution',
    cleanFuel: 'Clean Fuel',

    // SMS Demo
    smsDemo: 'SMS Bus Tracker',
    smsInstructions: 'Bus timing dekhne ke liye Stop Code sms karein',
    smsPlaceholder: 'Stop code likhein (ex: SML04)',
    smsSend: 'Bhejein',
    smsResponse: 'SMS Reply',
    smsNoStop: 'Stop code nahi mila. Try karein: SML01-SML10, SMN01-SMN13, DHM01-DHM07',

    // Admin
    dashboard: 'Dashboard',
    totalBuses: 'Total Active Buses',
    onTimePerformance: 'Time Par Chalne Wali Buses %',
    signalLostCount: 'No GPS Signal',
    cleanFleetPercent: 'Green Fleet %',
    recentAlerts: 'Taza Alerts',
    fleetOverview: 'Fleet Status',
    filterByDepot: 'Depot Filter',
    filterByRoute: 'Route Filter',
    filterByFuel: 'Fuel Filter',
    filterByStatus: 'Status Filter',
    allDepots: 'Sabhi Depots',
    allRoutes: 'Sabhi Routes',
    allFuelTypes: 'Sabhi Fuel Types',
    allStatuses: 'Sabhi Status',
    punctualityReport: 'Punctuality Report',
    emissionsReport: 'Emissions Report',
    fleetUtilization: 'Bus Utilization',
    breakdown: 'Breakdown',
    delayed: 'Late (Delayed)',
    running: 'On Time (Running)',
    acknowledge: 'Check Karein',
    resolve: 'Solve Karein',
    new: 'Naya',
    acknowledged: 'Check Kiya',
    resolved: 'Solved',
